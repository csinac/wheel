...
namespace RectangleTrainer.CustomAttributes
{
    ...
    public class ToggledIntAttribute : PropertyAttribute, IToggledAttribute
    {
        ...
        public ToggledIntAttribute(string boolController)
        {
        ...
        public ToggledIntAttribute(string intController, uint condition)
        {
